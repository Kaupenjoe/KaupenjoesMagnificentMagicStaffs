...
public class RubyStaff extends Item {
    public RubyStaff(FabricItemSettings properties) {
        super(properties);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            magicProjectile.setType(BasicMagicProjectileEntity.MagicProjectileType.RUBY);
