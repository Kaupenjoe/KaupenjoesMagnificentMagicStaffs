...
public class MagicColorUtils {
    public static Map<BasicMagicProjectileEntity.MagicProjectileType, Vector4f> PROJECTILE_VECTOR = Map.of(
                    ...
                    BasicMagicProjectileEntity.MagicProjectileType.RADIATION, new Vector4f(0.1f, 0.85f, 0.25f, 0.8f),
                    BasicMagicProjectileEntity.MagicProjectileType.VENOM, new Vector4f(0.4f, 0.25f, 0.5f, 0.8f));
    ...
    public static Map<Integer, Vector4f> PROJECTILE_VECTOR_BY_ORDINAL = Map.of(
                    ...
                    5, new Vector4f(0.1f, 0.85f, 0.25f, 0.8f),
                    6, new Vector4f(0.4f, 0.25f, 0.5f, 0.8f));
}
