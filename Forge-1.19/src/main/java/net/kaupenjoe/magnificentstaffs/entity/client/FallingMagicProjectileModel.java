...
public class FallingMagicProjectileModel<T extends FallingMagicProjectileEntity> extends EntityModel<T> {
    private final ModelPart bb_main;

    public FallingMagicProjectileModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(FallingMagicProjectileEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
