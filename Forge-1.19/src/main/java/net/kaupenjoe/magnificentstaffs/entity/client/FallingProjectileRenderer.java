...
public class FallingProjectileRenderer extends EntityRenderer<FallingMagicProjectileEntity> {
    ...
    public void render(FallingMagicProjectileEntity entity, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
    ...
    public ResourceLocation getTextureLocation(FallingMagicProjectileEntity entity) {
        return TEXTURE;
    }
}
