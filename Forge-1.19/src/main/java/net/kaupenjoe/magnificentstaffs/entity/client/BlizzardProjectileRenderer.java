...
public class BlizzardProjectileRenderer extends EntityRenderer<BlizzardMagicProjectileEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(StaffsMod.MOD_ID, "textures/entity/blizzard_projectile.png");
    protected BlizzardMagicProjectileModel model;

    public BlizzardProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
        model = new BlizzardMagicProjectileModel(context.bakeLayer(ModModelLayers.BLIZZARD_PROJECTILE_LAYER));
    }

    public void render(BlizzardMagicProjectileEntity entity, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
    ...
    public ResourceLocation getTextureLocation(BlizzardMagicProjectileEntity entity) {
        return TEXTURE;
    }
}
